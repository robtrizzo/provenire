  ...
  return (
    <>
      <TypographyP>
        ...
        <span className="font-bold text-fuchsia-600 underline">
      ...
      <TypographyUnorderedList>
        <li>Your sibling who hates you even though you provide for them</li>
        <li>
          Your shift workers who you&apos;ve kept organized and on-task all
          these years
        </li>
        <li>
          Your best friend who you had to report to the overseers, or else
          everyone in their family would have been killed
        </li>
      </TypographyUnorderedList>
      <TypographyP>
        Each time you make amends, mark <b>4 xp</b>.
      </TypographyP>
    </>
  );
}
