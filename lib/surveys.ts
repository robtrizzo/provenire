...
export const arcTwoSurvey: Survey = {
  title: "Arc Two State of the Game Survey",
  arc: "arc-two",
  categories: [
    {
      title: "Overall",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: 6,
          title: "How do you feel about extra sessions?",
          type: "multiple-choice",
          options: [
            {
              text: "I wish there were more!",
    ...
    },
    {
      ...
      questions: [
        {
          id: 8,
          title: "How do you feel about the overall narrative of Arc Two?",
          type: "multiple-choice",
          options: [
            {
              text: "Very Positively",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          id: 65,
          title:
            "How do you feel about the 'trauma-based' advancement system? e.g., Baggage, Donums in Arc One",
          type: "multiple-choice",
          options: [
            {
              text: "I love it!",
    ...
    },
    {
      ...
      questions: [
        ...
        {
          id: 66,
          title: "Did you like the inclusion of the emotion die?",
          type: "multiple-choice",
          options: [
            {
              text: "Yes, I love it!",
        ...
        {
          id: 25,
          title: "Did you like being able to swap out your actions?",
          type: "multiple-choice",
          options: [
            {
              text: "Yes, I love it!",
            ...
            {
              text: "Yes but it feels awkward sometimes.",
              color: "text-amber-500",
              value: "awkward",
            },
            {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          id: 50,
          title:
            "How did you feel about the Churn and Agendas being vastly simplified?",
          type: "multiple-choice",
          options: [
            {
              text: "Loved it!",
        ...
        {
          id: 53,
          title: "Did you miss the crew advancement system?",
          type: "multiple-choice",
          options: [
            {
              text: "Nope, Felt great without it!",
              color: "text-green-500",
              value: "great",
            },
            {
              text: "Felt good, but it felt like something was missing.",
              color: "text-amber-500",
              value: "slower",
            },
            {
              text: "Felt good, but we felt weaker because of it.",
              color: "text-violet-500",
              value: "faster",
            },
            {
              text: "Hated it, please bring it back.",
              color: "text-red-500",
              value: "hated",
            },
          ],
