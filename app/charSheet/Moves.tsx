...
const Move = ({
  ...
  return (
    ...
    >
      ...
      {hit && [
        <div
          className="result-row flex items-center justify-center gap-3"
          key="hit"
        >
          <h4 className="result-row-value font-bold">19+</h4>
          <p className="result-row-description">{hit}</p>
        </div>,
        <hr className="my-2" key="hit-divider" />,
      ]}
      {partial && [
        <div
          className="result-row flex items-center justify-center gap-3"
        ...
        <hr className="my-2" key="partial-divider" />,
      ]}
      {miss && [
        <div
          className="result-row flex items-center justify-center gap-3"
        ...
        <hr className="my-2" key="miss-divider" />,
      ]}
      {children}
    </article>
  );
