  ...
  return (
    <>
      ...
      <TypographyP>
        ...
        <span className="italic">churn</span>. My primary goal for playtest one
        is to evaluate the core rules.
      </TypographyP>
      <TypographyUnorderedList>
        <li>Do they work?</li>
      ...
      <TypographyBlockquote>
        The events of this playtest will be canonical to the story of the main
        game. So please experiment and push the boundaries of the game, but
