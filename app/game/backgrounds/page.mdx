...
<TypographyH2>
<span className="text-red-500">Operator</span><span className="text-muted-foreground text-lg ml-8">Pull levers and crank wheels</span>
</TypographyH2>
...
*A fellow worker hasn't been meeting quotas and you're not strong enough to cover for them. Who are they?*

### Mission

#### Actions

- **Disconnect (H):** Fortify your mind against upsetting stimuli.
- **Pull (I):** Move something heavy or difficult.
...
<TypographyH2>
<span className="text-red-500">Runner</span><span className="text-muted-foreground text-lg ml-8">Carry messages and transport crates</span>
</TypographyH2>
...
*An overseer took a shipment from you and framed you for it. What was in the shipment?*

### Mission

#### Actions

- **Carry (I):** Traverse the factory while under a heavy load.
- **Eavesdrop (M):** Listen in on a conversation without being noticed.
...
<TypographyH2>
<span className="text-red-500">Scrapper</span><span className="text-muted-foreground text-lg ml-8">Sort broken parts and salvage scrap</span>
</TypographyH2>
...
*You've found a nearly functional weapon meant for Fenrir's soldiers. What is it?*

*All your life you've heard whispered stories about the curse of the scrapyard. What have you experienced that makes you think they're right?

### Mission

#### Actions

- **Step (I):** Move carefully through dangerous terrain.
- **Rummage (M):** Search through refuse for something useful.
...
<TypographyH2>
<span className="text-red-500">Stoker</span><span className="text-muted-foreground text-lg ml-8">Shovel coal and stoke the fires</span>
</TypographyH2>
...
*You see something in the smoke and flames no one else does. What is it?*

*The overseers thought it would be funny to lock you all in the furnace room. Who did you lose that day?*

### Mission

#### Actions

- **Brace (H):** Prepare for a sudden pain or shock.
- **Fuel (M):** Inflame a fire or strong emotion.
