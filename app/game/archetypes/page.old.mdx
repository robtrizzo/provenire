...
**Climb the Ladder**: During downtime, the Executive may make a **[project roll](/game/prelude#project-rolls)** to climb the ladder of a community or organization that the crew is familiar with. Each completed project represents gaining higher positions. A controlled faction generates **goodwill** every downtime. Consequences of failure may include exploiting close friends and family or owing difficult favors.
