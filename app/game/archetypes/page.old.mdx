...
<TypographyH2 id="strategist" className="flex items-end">
  <span className="text-amber-500">Strategist</span>
...
<TypographyH2 id="commander">
  <span className="text-amber-500">Commander</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="advocate">
  <span className="text-amber-500">Advocate</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="idealist">
  <span className="text-amber-500">Idealist</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<span className="inline-block text-amber-500 font-bold">Lead the Way</span>: When a fight starts, you may lead from the front. If you do, the first allied action in the fight gains increased effect. The first enemy action in the fight will target you if possible.
...
<TypographyH2 id="dreamer">
  <span className="text-amber-500">Dreamer</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="logistician">
  <span className="text-amber-500">Logistician</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="defender">
  <span className="text-amber-500">Defender</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<span className="inline-block text-amber-500 font-bold">Showing Up</span>: **+1d** to resistance rolls to defend an ally
...
<TypographyH2 id="executive">
  <span className="text-amber-500">Executive</span>
  <span className="text-muted-foreground text-lg ml-8">
...
**Climb the Ladder**: During downtime, the Executive may make a **[project roll](/game/actions-and-rolls#project-rolls)** to climb the ladder of a community or organization that the crew is familiar with. Each completed project represents gaining higher positions. A controlled faction generates **goodwill** every downtime. Consequences of failure may include exploiting close friends and family or owing difficult favors.

<TypographyH2 id="consul">
  <span className="text-amber-500">Consul</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="virtuoso">
  <span className="text-amber-500">Virtuoso</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="artist">
  <span className="text-amber-500">Artist</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<TypographyH2 id="entertainer">
  <span className="text-amber-500">Entertainer</span>
  <span className="text-muted-foreground text-lg ml-8">
...
<span className="inline-block text-amber-500 font-bold">A Spontaneous Spirit</span>: When the Entertainer leads a **group action**, they can eschew making a roll themselves to instead increase the effect of the action. If they succeed, they mark **1 xp**.
