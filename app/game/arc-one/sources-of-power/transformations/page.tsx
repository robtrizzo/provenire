...
export default async function Page() {
  return (
    <>
      ...
      <ConditionalLink
        href="/game/arc-one/sources-of-power/transformations/donum-rex"
        perm="donum-rex"
      >
        <TypographyH3>
          Donum Rex{" "}
      ...
      <div className="w-full flex justify-between">
        <Link href="/game/arc-one/sources-of-power/aldams">
          <Button variant="outline">
            <ChevronLeft /> Aldams
          </Button>
        </Link>
        <Link href="/game/arc-one/sources-of-power/donums">
          <Button variant="outline">
            Donums <ChevronRight />
          </Button>
        </Link>
