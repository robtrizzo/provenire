...
export default async function Page() {
  return (
    <>
      ...
      <TypographyH2 id="the-vault">The Vault</TypographyH2>
      ...
      <div className="w-full flex justify-between">
        <Link href="/game/arc-one/sources-of-power/transformations">
          <Button variant="outline">
            <ChevronLeft /> Transformations
          </Button>
        </Link>
        <Link href="/game/arc-one/sources-of-power/curses">
          <Button variant="outline">
            Curses <ChevronRight />
          </Button>
        </Link>
...
async function DonumList() {
  ...
  return (
    <>
      ...
      <ConditionalLink href="donums/donum-vitae" perm="donum-vitae">
