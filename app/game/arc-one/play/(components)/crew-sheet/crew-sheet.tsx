...
import Forge from "@/app/game/arc-one/the-churn/(agendas)/forge";
import Explore from "@/app/game/arc-one/the-churn/(agendas)/explore";
import Pit from "@/app/game/arc-one/the-churn/(agendas)/pit";
import Carve from "@/app/game/arc-one/the-churn/(agendas)/carve";
import Gamble from "@/app/game/arc-one/the-churn/(agendas)/gamble";
import Know from "@/app/game/arc-one/the-churn/(agendas)/know";
import Worth from "@/app/game/arc-one/the-churn/(agendas)/worth";
import Walk from "@/app/game/arc-one/the-churn/(agendas)/walk";
