...
import PipedancingSkillTree from "@/components/fighting-styles/pipedancing-skill-tree";
  ...
  return (
    <div>
      ...
      <TypographyP>
        ...
        learned{" "}
        <Link href="/game/arc-one/aldam#bronze-coils">
