...
After a mission, the PCs take stock of the events of the operation. The crew earns **rep** according to the following:
...
Some harm can't be healed by normal means. Examples incude "hungry" and "tired". These can have their levels reduced by recovery, but require specific actions to heal entirely.
