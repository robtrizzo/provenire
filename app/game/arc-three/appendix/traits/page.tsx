...
export default async function Page() {
  return (
    <>
      <Breadcrumbs />
      <TypographyH1>Traits</TypographyH1>
      ...
      <TypographyP className="not-first:mt-0">
        <b>Dull:</b> can't cut through anything more protective than clothing
      </TypographyP>
      <TypographyP className="not-first:mt-0">
      ...
      <TypographyP className="not-first:mt-0">
        <b>Loyal:</b> won't be swayed away from the crew by bribes or nonlethal
        pressure
      </TypographyP>
      <TypographyP className="not-first:mt-0">
