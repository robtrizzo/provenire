      ...
      <main className="md:columns-2">
        <article>
          ...
          <TypographyP>
            ...
            branch to <strong>Ara</strong>, invaders from another world. History
            is happening: and the powers that be are scrambling to turn it to
            their advantage.
          </TypographyP>
        </article>
        <article>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <TypographyP className=" text-red-500 ">
                    ...
                    terror known for their use of <Donum>Donum Dolus</Donum> to
                    shape world events through manipulation and assassination.
                  </TypographyP>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          ...
          <TypographyP>
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <TypographyP className=" text-red-500 ">
                    An elite force of <b>Anidine&apos;s</b> best soldiers. To a
                    man, they are all experts of <Donum>Donum Ferro</Donum> and
                    are equipped with several <b>Adamantine</b> war machines.
                  </TypographyP>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <TypographyP className=" text-red-500 ">
                    ...
                    leader. Now it&apos;s enormous, well equipped, and always a
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <TypographyP className=" text-red-500 ">
                    ...
                    <b>Okazaki Taisho</b> succeeded the head of the house, it
                    became a an abyssal pit of depravity and corruption.
                  </TypographyP>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <TypographyP className=" text-red-500 ">
                    ...
                    Unshackled from his own destiny by <b>Asherah the Healer</b>{' '}
                    and granted unknown powers by a red eye with a strange
                    pupil.
                  </TypographyP>
                </TooltipContent>
              </Tooltip>
      ...
      <main className="md:columns-2">
        ...
        <article>
          ...
          <TypographyP>
            ...
            departed. Now only the core of its territory remains, but it&apos;s
            still the world&apos;s military superpower - and it&apos;s itching
            for a war.
          </TypographyP>
          <TypographyP>
            <Link
