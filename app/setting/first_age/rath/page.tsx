  ...
  return (
    <>
      ...
      <p>
        ...
        leaving be anything they doin't require. They strive not to make a
      ...
      <p>
        People of other cultures recoil at the <strong>Rathi's</strong> customs,
        but the <strong>Rathi</strong> claim it to be necessary to cull the weak
        bloodlines and proliferate the strongest ones.
      </p>
      <p>
        This however, leads to swaths of wifeless <strong>Rathi</strong> men,
        the <em>Unwurdig</em>. The <em>Unwurdig's</em> lot in life is ravenously
        pursuing any battle, any challenge they possibly can: in the hopes that
        they will be noticed and awarded a wife.
      </p>

      <h2>Of Men and Monsters</h2>
      <p>
      ...
      <p>
        Despite their beliefs about water, <strong>Kingwulf's</strong> children
        are always sent to <strong>Helix</strong> for{' '}
