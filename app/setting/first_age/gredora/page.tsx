  ...
  return (
    <>
      ...
      <p>
        ...
        metal that is more than significant, it's holy: <em>adamantine</em>. The
        metal defies all of the science <strong>Gredorans</strong> have managed
        to discover. In the hands of a normal person, it's supernaturally light
        and durable, and it can't be manipulated by <Donum>Donum Ferro</Donum>.
        In the hands of a <em>blood mage</em> however, it's a legendary tool.
      </p>
      <p>
