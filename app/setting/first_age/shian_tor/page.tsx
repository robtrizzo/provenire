...
export default function ShianTor() {
  return (
    <>
      <h1>Shian Tor</h1>
      <blockquote>
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="w-1/2 h-fit p-4 bg-slate-900 div-2 box-border border-t-2 border-b-2 text-white">
          <h6>Specter's Boon</h6>
          <p>
            The <strong className="text-white">Torans</strong> were only ever
            blessed with one <em>Donum</em>, and fortunately for them it is the
            most feared <em>Donum</em> across all seven cultures.
          </p>
      ...
      <p>
        ...
        be repaid. The two don't cancel each other out, they are both a part of
        life.
      </p>
      <p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/first_age/rath" text="Rath" />
        <Next href="/setting/second_age" text="The Second Age" />
      </div>
    </>
  );
}
