  ...
  return (
    <>
      ...
      <blockquote>
        ...
        "Greatest King" dared brave the darkness of the{' '}
      ...
      <p>
        ...
        They are still held in high esteem since just surviving the hunter's
        test is an accomplishment. Scavengers serve as scouts and gatherers.
        They train to become master climbers and traverse the{' '}
      ...
      <p>
        There are some who take the hunter's test and flee. They are cast out as
        cowards, left to fend for themselves.
      </p>
      <p>
      ...
      <h2>Warriors of Reckless Abandon</h2>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          <p>
            ...
            <strong>Kilder</strong>, and <strong>Rathi</strong> for the forest's
            greatest resource: <em>Adamantine</em> - harvested from the bones of
            the <strong>Titan Pines'</strong> deadliest predator - the{' '}
            <strong>Naga</strong>.
          </p>
          <p>
      ...
      <p>
        ...
        predators who could clearly climb wouldn't follow them. It wasn't until
        a few brave scavengers climbed even higher into the trees that they
      ...
      <p>
        In the generations to come, those scavengers' descendants grew up with
        the young of the griffons, eventuaslly bonding enough to become the
      ...
      <h2>The Horns of Life</h2>
      <blockquote>
        Most unlucky folk only ever hear the <strong>Cumerian's</strong>{' '}
        warhorns. But there's a second kind of horn the blow. If you're
        fortunate enough to hear those, seek them out. You will never feast with
        more gracious and wonderful hosts.
      </blockquote>
      <p>
      ...
      <blockquote>
        <p>
          ...
          <strong>Life Duct</strong>. A brief rest, I told myself. I'd be back
          on my feet soon. So much blood was pooling in the basin. Enough for my
          family to drink for weeks, I remember thinking. The warcries and death
          dirges were so loud they made my head throb with the noise.
        </p>
        <p>
