  ...
  return (
    <>
      ...
      <p>
        ...
        their harsh homelands. Bloody war ensued.
      </p>
      <p>
      ...
      <p>
        But <strong>water</strong> wasn't the only rare resource in the world.
        Sturdy wood, sculptable stone, workable metal, medicinal herbs,
      ...
      <p>
        Thanks to <strong>Anya Arbor's</strong> sacrifices, <em>Donums</em> have
        spread to each region with the exception of <strong>Kilder</strong>.
