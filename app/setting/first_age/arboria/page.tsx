...
export default function Arboria() {
  return (
    <>
      <h1>Arboria</h1>
      <blockquote>
        We are the chosen. The descendants of the first <em>Donum</em>, and it's
        finest masters. It is our destiny to shape the world as she intended it.
      </blockquote>
      <p>
        <em>Donum</em> is the <strong>Arborian</strong> word for 'The Gift,' as{' '}
        <strong>Jolana Arbor</strong> called it centuries ago. To wield a{' '}
        <em>Donum</em> means that one has inherited some of the soul of{' '}
        <strong>Jolana</strong>, as an <strong>Arborian</strong> would put it.
      </p>
      <h2>Civilized Pursuits</h2>
      <p>
      ...
      <p>
        ...
        hunbter. The attitude is that if an <strong>Arborian</strong>{' '}
        ...
        disrespect for the <strong>Aroborian</strong> legacy of architecture and
        agricultural plenty.
      </p>
      <h3>Community and Charity</h3>
      <blockquote>If you have a need, your only need is to ask!</blockquote>
      <p>
      ...
      <p>
        ...
        hospitals. Any "self respecting <strong>Arborian</strong>" does their
        best to make the largest contribution to society. That can take the form
        of raising orphans, sending their children to the most prestigious
        schools and academies, tending to the sick, or creating public art.{' '}
      </p>
      <h2>Helix</h2>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          <p>
            ...
            sent to <strong>Helix</strong>{' '}
            for the best possible upbringing in the arts of <em>Wielding</em>.
          </p>
          <p>
        ...
        <div className="w-1/2 h-fit p-4 bg-slate-900 div-2 box-border border-t-2 border-b-2 text-white">
          ...
          <p>
            ...
            <strong className="text-white">Arboria's</strong> founder,{' '}
            <strong className="text-white">Anya Arbor</strong>, the{' '}
            <strong className="text-white">Arborian</strong> language has always
            been used to name the powers which <em>Wielders</em> manifest. Rough
            translations of the <em>Donums</em> most-to-least commonly found in{' '}
            <strong className="text-white">Arboria</strong> are:
          </p>
      ...
      <p>
        ...
        <strong>Willows</strong>, and those who do are folk hardened by hears of
