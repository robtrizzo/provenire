  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>Helix</strong> and are ushered to <strong>Jolana's Duct</strong>
        .
      </p>
      <p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/first_age" text="The First Age" />
        <Next href="/setting/first_age/cumeria" text="Cumeria" />
      </div>
    </>
  );
}
