...
export default function Narscillia() {
  return (
    <>
      <h1>Narscillia</h1>
      <blockquote>
        It's truly special, what they have. Everywhere they go, they make people
        happy, hopeful, excited to meet new friends.
      </blockquote>
      <h2>Celebrate Light, Life</h2>
      <p>
        ...
        the border to take temporary part in the daily celebrations.
      </p>
      <p>
      ...
      <blockquote>
        <p>That tone, the one that sound skind of sad, what is that one for?</p>
        <p>A red cape on the horizon.</p>
      </blockquote>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          ...
          <p>
            ...
            the good of their kinsmen. Suffering so that others don't need to.
            For a <em>Relict</em>, death would truly be a release from their
