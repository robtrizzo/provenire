...
export default function Kilder() {
  return (
    <>
      ...
      <h2>Survival Through Dicipline</h2>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          <p>
            ...
            Philosopher. Regardless of that child's predispositions, that role
            becomes their lot in life, and they are taught to strive to be the
            best possible incarnation of their role.
          </p>
          <p>
            ...
            their position. Such perfection, in the <strong>Kilder's</strong>{' '}
            eyes, is the maning of life and the way that the{' '}
            <strong>Kilder</strong> will one day conquer the land they inhabit.
          </p>
          <p>
      ...
      <p>
        ...
        the skill of the hunter. Most hunters don't complete their wreath before
        the creatures of the marsh take them.
      </p>
      <h2>Bone Spears and Wicker Baskets</h2>
      <p>
      ...
      <p>
        ...
        responsibility of forging weapons and armor for the warband's greatest
        warriors.
      </p>
      <p>
      ...
      <p>
        The other large part of a craftman's routine is practicing music on the
        drums and flutes they've made. Each night the craftsmen play their
        instruments as the philisophers sing and the the hunters dance and spar.
      </p>
      <h2>Slayers of Men</h2>
      <p>
