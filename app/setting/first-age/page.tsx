...
export default function Page() {
  return (
    <>
      <TypographyH1>The First Age</TypographyH1>
      <TypographyP>
        <strong>Anya Arbor</strong> quickly became a god to the people of the
      ...
      <TypographyH2>Outside Arboria</TypographyH2>
      <TypographyP>
      ...
      <TypographyP>
        ...
        forest and surrounded by ravenous predators.
      </TypographyP>
      <TypographyP>
        <strong>The Gredorans</strong> awoke on a grassy steppe to the heat on
        an impending lava flow.
      </TypographyP>
      <TypographyP>
        <strong>The Rathi</strong> were abandoned to survive in a dense and
        unforgiving jungle.
      </TypographyP>
      <TypographyP>
        <strong>The Narscillians</strong> were stirred from sleep by shifting
        sands and a parching sun.
      </TypographyP>
      <TypographyP>
        <strong>The Torans</strong> began to wander expansive grasslands and
        sheer mountains.
      </TypographyP>
      <TypographyP>
      ...
      <TypographyH2>Migrant War // Slaughter of the Foothills</TypographyH2>
      <TypographyP>
        ...
        as the rightful heirs to the city as <strong>Jolana&apos;s</strong>{' '}
        kinsmen. The migrants were forced to decide wether to fight, or to go
        back to their harsh homelands. Bloody war ensued.
      </TypographyP>
      <TypographyP>
      ...
      <TypographyP>
        ...
        back the migrants to their homelands, fated to toil and dwindle away.
      </TypographyP>
      <TypographyH2>Anya&apos;s Labors // The Accord War</TypographyH2>
      <TypographyP>
      ...
      <TypographyH2>Anya&apos;s Death // Death of the Accords</TypographyH2>
      <TypographyP>
      ...
      <TypographyH2>Era of War</TypographyH2>
      <TypographyP>
      ...
      <TypographyP>
        But <strong>water</strong> wasn&apos;t the only rare resource in the
        world. Sturdy wood, sculptable stone, workable metal, medicinal herbs,
        harvestable nuts and berries, less formiddable game - all heavily
        contested by neighboring peoples. The cultures which were briefly united
        to march on <strong>Helix</strong> couldn&apos;t be called anything
        resembling nations. Despite sharing languages and common customs, the
        peoples of each region stuck to their own, and competed for resources.
      </TypographyP>
      <TypographyP>
        Outside of <strong>Helix</strong>, the huntable game is incredibly
        deadly. Being a hunter is synonymous with being a talented fighter.
      </TypographyP>
      <TypographyP>
        With so many warriors, conflicts among peoples lead to bloodly wars
      ...
      <TypographyH2>Ghodbane&apos;s Campaign</TypographyH2>
      <TypographyP>
      ...
      <TypographyP>
        <strong>Ghodbane&apos;s</strong> demands were not surrender or material.
        The first demand was to found a peacekeeping force based in{' '}
        <strong>Helix</strong> in which any nation&apos;s warriors could join,
        should they prove themselves strong enough. The second demand was to
        reinstate the <strong>Helix Accords</strong> with an amendment to the
        election process. No longer would leaders be chosen with the corrupted
        democracy that had festered in <strong>Helix</strong>. Instead,{' '}
        <strong>Helix&apos;s</strong> council would be elected in trial by
        combat, hosted once every fifty years.
      </TypographyP>
      <TypographyP>
        <strong>Fleur Mercator</strong> discussed this with the other members of{' '}
        <strong>Helix&apos;s</strong> council. They found these demands
        barbaric, disastrous, and unacceptable.
      </TypographyP>
      <TypographyP>
        Much to the council&apos;s dismay, and then rage, <strong>Fleur</strong>{' '}
        ignored their council and agreed to <strong>Ghodbane&apos;s</strong>{' '}
        demands.
      </TypographyP>
      <TypographyP>
      ...
      <TypographyH2>Present Day</TypographyH2>
      <TypographyP>
        <strong>Helix</strong> still stands, as do the{' '}
        <strong>Helix Accords</strong>. Where <strong>Helix</strong> is still
        within <strong>Arborian</strong> territory, it&apos;s ruled by a council
        of representatives from all the nations. The council is responsible for
        overseeing the city and selecting the <strong>Imperator</strong>: the
        ruler of <strong>Helix</strong>.
      </TypographyP>
      <TypographyP>
        Thanks to <strong>Anya Arbor&apos;s</strong> sacrifices, <em>Donums</em>{' '}
        have spread to each region with the exception of <strong>Kilder</strong>
        . Around one in one thousand people recieve <em>Donums</em>. The variety
        of the powers differentiate between regions, communities, families, and
        the individual; however, differences become smaller and smaller as
        wielders are closer in blood.
      </TypographyP>
      <TypographyP>
        Absent <strong>Anya&apos;s</strong> mythical power, each people has been
        left to learn the secrets of each <strong>Life Duct</strong>. The
        communites that survive are the ones which have learned to activate the{' '}
      ...
      <div className="w-full flex justify-between">
        <Link href="/setting">
          <Button variant="outline">
            <ChevronLeft /> Before Memory
          </Button>
        </Link>
        <Link href="/setting/first-age/arboria">
          <Button variant="outline">
            Arboria <ChevronRight />
          </Button>
        </Link>
      </div>
    </>
