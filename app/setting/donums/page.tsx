...
export default function Donums() {
  return (
    <>
      <h1>Donums</h1>
      <p>
        <Donum>Donum</Donum> is the <strong>Arborian</strong> word for 'gift',
        representing how the <strong>Arborians</strong> believe these powers to
        be gifts from their god, <strong>Jolana Arbor</strong>. Also according
        to the <strong>Arborians</strong>, <strong>Jolana's</strong> daughter{' '}
      ...
      <p className="pl-4">
        ...
        <em>wielder's</em> transformation varies dramatically: especially if
        they have other <Donum>Donums</Donum> as well.
      </p>
      <p className="pl-4">
