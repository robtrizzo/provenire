...
export default function Anidine() {
  return (
    <>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          <p>
            ...
            King's <strong>Wisdoms</strong> and Barons, who each rule a state of
            the <strong>Anidine</strong> empire. Beneath Barons and{' '}
            <strong>Wisdoms</strong> are their knights and hunters, each ruling
            a small region of their lord's borders. Beneath them are the common
            people. By decree of the <strong>New Gods</strong>, those who rule
            are tasked with protecting the country and its people, while also
            helping them flourish.
          </p>
        </div>
        <div className="w-1/2 h-fit p-4 bg-rose-950 div-2 box-border border-t-2 border-b-2 text-white">
          <h6>Remnants of the Old Empire</h6>
          <p>
      ...
      <h2>Rising Above</h2>
      <blockquote>Kings born of blood end in their kingdom's blood.</blockquote>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          ...
          <p>
            ...
            <strong>Titan Pines</strong> or <strong>Gredora's</strong> gleaming
            legions.
          </p>
        </div>
      ...
      <p>
        ...
        if only they could see the beauty in unity. That it's the solemn duty of{' '}
        <strong>Anidine</strong> to unite the world under the rule of the divine
        right of Kings.
      </p>
      <h2>Oaken Moot</h2>
      <p>
        <strong>Anidine's</strong> greatest city, <strong>Oaken Moot</strong>{' '}
        sits atop a great plateau, looking down upon the rest of the kingdom.
        Before the city though was the <strong>Oaken Moot</strong>, the stump of
        one of the largest <strong>Titan Pines</strong> in{' '}
        <strong>Cumeria</strong>. The stump serves as the floor of the council's
        congress, where all <strong>Ainidinian</strong> lords meet and see each
        other as equals. They are overseen by the Monarch, who sits apart from
        them on a grand throne of <em>Adamantine</em>.
      </p>
      <h3>Life in Oaken Moot</h3>
      <p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/second_age" text="New Beginning" />
        <Next href="/setting/second_age/argos" text="Argos" />
      </div>
    </>
  );
}
