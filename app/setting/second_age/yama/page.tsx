    ...
    <>
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="w-1/2 h-fit p-4 bg-rose-950 div-2 box-border border-t-2 border-b-2 text-white">
          ...
          <p>
            Before the <strong className="text-white">Golden Age</strong>, what
            is now <strong className="text-white">Heia</strong> was a nation
      ...
      <p>
        ...
        <strong>Yamans</strong> were unwilling to let go of their ways and the{' '}
        <strong>Gredorans</strong> were no longer willing to live under them.
      </p>
      <p>
      ...
      <p>
        ...
        drips and fills the city's central basin from which all of the channels
        flow. The <strong>Water Moon</strong> is both the city's greatest asset
        and it's diety.
      </p>
      <h3>Twin Dictates</h3>
      <p>
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="w-1/2 h-fit p-4 bg-slate-900 div-2 box-border border-t-2 border-b-2 text-white">
          ...
          <p>
            <strong className="text-white">Yama</strong>, like{' '}
            <strong className="text-white">Kipos</strong> seems to have gained
            the most new and unusual <em>Donums</em> of the{' '}
            <strong className="text-white">Second Age</strong>.
          </p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/second_age/narscillia" text="Narscillia" />
      </div>
    </>
  );
}
