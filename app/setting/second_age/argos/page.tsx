  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>Arbor</strong> <em>Wielders</em> who aren't strong enough for a
        house position still find success in the world of sports.
      </p>
      <h3>House Santoris</h3>
      ...
      <p>
        ...
        <strong>Prisca</strong> has made it known to <strong>Helix's</strong>{' '}
        nobles that they know all about their private affairs.
      </p>
      <p>
        ...
        its involvement in these events. The world's nobility largely looks the
        other way, lest they be next on <strong>Prisca's</strong> docket.
      </p>
      <h2>Academia Arcadia</h2>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          <p>
            ...
            class of less than thrity. It's a place where mettle is tested, a
            crucible for the young and talented, a <em>provenire</em> as its
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/second_age/anidine" text="Anidine" />
        <Next href="/setting/second_age/bwarhei" text="Bwarhei" />
      </div>
    </>
  );
}
