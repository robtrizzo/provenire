  ...
  return (
    <>
      ...
      <p>
        ...
        be seen starkly in the nation's only city: <strong>Dragon Lakes</strong>
        .
      </p>
      <div className="flex flex-row gap-2">
        ...
        <div className="w-1/2">
          <div className="h-fit p-4 bg-rose-950 div-2 box-border border-t-2 border-b-2 text-white">
            <h6>Cultures Coming Together</h6>
            <p>
      ...
      <p>
        ...
        country, especially since it's fairly likely that one won't see combat
        while in service.
      </p>
      <h2>Dragon Lakes</h2>
      <p>
        The metal city, or "Metal Helix" as the <strong>Argosi</strong> and{' '}
        <strong>Kiposi</strong> call it. Its layout is very reminiscent of{' '}
        <strong>Helix</strong>, as the four main streets spiral out from the
        center palace. But that is where the similarities end. The architecture
        of the inner city is glistening brass towers and spires. A network of
        elegant sky bridges span the gap between towers high in the sky.
      </p>
      <p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/second_age/gredora" text="Gredora" />
        <Next href="/setting/second_age/kilder" text="Kilder" />
      </div>
    </>
  );
}
