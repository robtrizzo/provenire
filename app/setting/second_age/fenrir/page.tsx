  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>Vandalwulf's</strong> word is nothing compared to the King's.
      </p>
      <p>
      ...
      <blockquote>
        Why do the <strong>Kiposi</strong> fight so hard to keep us out? Don't
        they want their lives to be as grand as ours? I suppose that's why we
        have to show those fools the way by force.
      </blockquote>
      <h4>The Great Well</h4>
      <p>
      ...
      <h4>King's Glory</h4>
      <p>
        <em>King's Glory</em> is <strong>Fenrir's</strong> largest city, in fact
        it may be the world's largest city. It is difficult to tell the true
        number of residents since without walls, it sprawls in all directions.
        The center of the city however, is far different from the squalor of the
        outer city. The King District is a massive complex of marble palaces,
        fortresses, and academies. Most namely of them all are the Palace of
        Pride where <strong>Kingwulf</strong> resides, Tooth and Nail Fortress
        where <strong>Vandalwulf</strong> resides, and Darkeye Academy.
      </p>
      <p>
      ...
      <p>
        ...
        <strong>Fenrir's</strong> aristocracy: families with powerful bloodlines
        who have produced a worthy brood for many generations. They stay in the
        city to serve <strong>Kingwulf</strong> directly in hopes of currying
        his favor and being awarded more wives with which to expand their
        heritage.
      </p>
      <p>
      ...
      <div className="flex flex-row gap-2">
        <div className="w-1/2">
          <p>
            ...
            She rules over the empire's northern provices, overseeing all the
            lands that were once <strong>Cumerian</strong>. She and the
          ...
          <p>
            ...
            <em>Adamantine</em>. And it is the <strong>Bear Pack's</strong> duty
            to protect these people as well as maintaining the border that is so
            hard-fought.
          </p>
          <h4>Colony</h4>
          <p>
      ...
      <p>
        ...
        at the <strong>Duke of Bears's</strong> doorstep, replacements which she
        despearately needs. She tells them to fret not, they will lead a
        meaningful life under her guidance. Under her, they will expand the
        ...
        lines to pave their bretherens' way to victory on the battlefield. They
        will make <strong>Colony</strong> a better place for the future, and for
        the glory of <strong>Fenrir</strong>.
      </p>
      <h3>The Raven Flock</h3>
      <p>
      ...
      <p>
        ...
        but he doesn't care for a throne. In fact, he doesn't like to be
        recognized at all. His orders are issued through a network of captains,
        but other than them, no one knows what he looks like. It's said that in
        battle, he dresses in the exact same uniform as the common soldiers so
        that enemy commanders can't know when to expect his blade at their
        throats.
      </p>
      <h4>Cleansing City</h4>
      <p>
      ...
      <p>
        ...
        by their Shepherds, priests handpicked by <strong>Ansisamslo's</strong>{' '}
        captains to watch over the children. Once in the city, the children
        undergo rigorous and brutal education and physical training. Those who
        can't keep up are sent to the North to reinforce{' '}
        <strong>Gaathabaira</strong>. Those who show promise are instead sent to
        the capitol to be recognized by the King.
      </p>
      <p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/second_age/cumeria" text="Cumeria" />
        <Next href="/setting/second_age/gredora" text="Gredora" />
      </div>
    </>
  );
}
