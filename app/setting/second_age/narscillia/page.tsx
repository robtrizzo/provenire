  ...
  return (
    <>
      ...
      <div className="flex flex-row gap-2">
        ...
        <div className="w-1/2 h-fit p-4 bg-slate-900 div-2 box-border border-t-2 border-b-2 text-white">
          ...
          <p>
            ...
            <strong className="text-white">Narscillian</strong> children,
            perhaps no other has had quite the impact of{' '}
            <Donum>Donum Ventus</Donum>, or the Gift of Wind. Wind power
            revolutionized <strong className="text-white">Narscillian</strong>{' '}
          ...
          <p>
            ...
            <strong className="text-white">Narscillians</strong> still recieve
            their traditional <em>Donums</em>.
          </p>
      ...
      <p>
        ...
        <strong>Narscillia's</strong> spear and shade. <strong>Relict</strong>{' '}
        children have the fate of their people on their shoulders. They have the
        lessons of their forefathers drilled into them.
      </p>
      ...
      <div className="flex flex-row mt-2">
        <Previous href="/setting/second_age/kipos" text="Kipos" />
        <Next href="/setting/second_age/yama" text="Yama" />
      </div>
    </>
  );
}
