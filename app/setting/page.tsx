export default function World() {
  return (
    <>
      <h1>Before anyone can remember</h1>
      <p>
        <strong>Jolana Arbor</strong> woke up.
      </p>
      <p>She wandered fields resting thousands of slumberers.</p>
      <p>
      ...
      <p>
        ...
        whispering into <strong>Anya's</strong> ear and kissing her one last
        time.
      </p>
      <p>
      ...
      <h2>Awakening</h2>
      <p>Those who awoke found themselves in a harsh and unforgiving world.</p>
      <p>
